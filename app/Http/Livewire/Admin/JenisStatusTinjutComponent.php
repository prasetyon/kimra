...
class JenisStatusTinjutComponent extends Component
{
    // Load addon trait
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.jenis-status-tinjut-component', [
            // Lists
            'lists' => JenisStatusAksi::when($searchData, function ($searchQuery) use ($searchData) {
                $searchQuery->where([
    ...
    public function store()
    {
        ...
        JenisStatusAksi::updateOrCreate(['id' => $this->input_id], [
    ...
    public function edit($id)
    {
        ...
        $data = JenisStatusAksi::findOrFail($id);
    ...
    {
        // Find existing photo
        $sql = JenisStatusAksi::where('id', $id)->firstOrFail();
